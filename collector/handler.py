...
class DataHandler:
    ...
    def plot_speeds_changes(self, **kwargs):
        ...
        for vehid, ax in zip(range(5), a.flatten()):
            ...
            self.plot_curves(self.data, col2plot, ax=ax, c="lightsteelblue", **kwargs)
            self.plot_curves(self.data[self.data[changes(vehid)]], col2plot, ax=ax, kind="scatter", c="r", **kwargs)
        return f, a
